...
CREATE TABLE notice (
                        ...
                        updatedChargeId BIGINT,
                        views INT NOT NULL,
                        type ENUM('CLASS', 'SCHOOL','ELECTIVE') NOT NULL,
                        classId BIGINT,
                        loginId VARCHAR(20),
                        courseId BIGINT,
...
CREATE TABLE classes (
                       ...
                       year INT NOT NULL,
                       grade ENUM('LOWER_KG', 'NURSERY', 'PLAYGROUP', 'UPPER_KG', 'CLASS1', 'CLASS2', 'CLASS3', 'CLASS4', 'CLASS5', 'CLASS6', 'CLASS7', 'CLASS8', 'CLASS9', 'GRADUATED') NOT NULL,
