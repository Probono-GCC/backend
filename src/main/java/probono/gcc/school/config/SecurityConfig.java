            ...
            .configurationSource(new CorsConfigurationSource() {
              ...
              public CorsConfiguration getCorsConfiguration(HttpServletRequest request) {
                ...
                configuration.setAllowedOrigins(
                    Arrays.asList("http://localhost:3000", "http://43.202.12.44", "http://www.cla-school.site", "http://cla-school.site/"));
    ...
    http
        .authorizeHttpRequests((auth) -> auth
            ...
            .requestMatchers("/login", "/", "/swagger-ui/**", "/v3/api-docs/**", "/test", "/test2",
                "/users/**", "/checkPwAnswer/**", "/resetPassword/**", "/students/migration", "/actuator/**")
            .permitAll()
